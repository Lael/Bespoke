...
interface BilliardsColorScheme {
  clear: ColorRepresentation,
  table: ColorRepresentation,
  outerSingularities: ColorRepresentation,
  sphere: ColorRepresentation,
}
...
const SPHERE_OUTER_ORBIT_COLOR = 0x000000;
