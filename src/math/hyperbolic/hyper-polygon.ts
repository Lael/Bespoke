...
import {HyperbolicModel, HyperGeodesic, HyperIsometry, HyperPoint, trueToPoincareDistance} from "./hyperbolic";
...
export class HyperPolygon {
  ...
  static fromAngles(angles: number[]): HyperPolygon {
    ...
    if (a0 === 0 && a1 === 0 && a2 === 0) {
      ...
      const l0 = trueToPoincareDistance(t0);
      v0 = HyperPoint.fromPoincare(Complex.polar(1, Math.PI / 2));
      ...
      const l01 = trueToPoincareDistance(t1 / 2);
      const l02 = trueToPoincareDistance(t2 / 2);
  ...
  interpolateVertices(model: HyperbolicModel): Complex[] {
