...
import {closeEnough, EPSILON, normalizeAngle} from "../math-helpers";
...
export class ArcSegment extends Segment {
  ...
  override containsPoint(p: Complex): boolean {
    ...
    const theta = normalizeAngle(this.center.heading(p) + EPSILON, this.startAngle) - EPSILON;
    return theta <= this.endAngle + EPSILON;
  }
